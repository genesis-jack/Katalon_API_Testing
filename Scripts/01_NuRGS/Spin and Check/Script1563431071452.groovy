...
for (int i = 0; i <= 2; i++) {
	...
	WebUI.callTestCase(findTestCase('00_Excel/Data to Excel-Login and Spin'), [:], FailureHandling.CONTINUE_ON_FAILURE)
	...
	WebUI.callTestCase(findTestCase('02_Back Office/PTH-Detail'), [:], FailureHandling.CONTINUE_ON_FAILURE)
	// Write PTH API Response To Excel
	WebUI.callTestCase(findTestCase('00_Excel/Data to Excel-PTH'), [:], FailureHandling.CONTINUE_ON_FAILURE)
	// Compare PTH and rgs-history
	WebUI.callTestCase(findTestCase('00_Excel/Compare Data-PTH vs RGS_History'), [:], FailureHandling.CONTINUE_ON_FAILURE)
