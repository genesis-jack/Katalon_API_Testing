...
String excelFile01 = '/Users/jack.c/git/Katalon_API_Testing/Data Files/STG_Login and BaseSpin.xlsx'
...
for (int i = 0; i <= 1; i++) {
	...
	WebUI.callTestCase(findTestCase('_STG/01_NuRGS/RGS History-Base Spin'), [:], FailureHandling.CONTINUE_ON_FAILURE)
	...
	WebUI.callTestCase(findTestCase('_STG/02_Back Office/PTH-Detail-Base Spin'), [:], FailureHandling.CONTINUE_ON_FAILURE)
