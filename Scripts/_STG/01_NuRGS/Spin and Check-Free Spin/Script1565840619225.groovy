...
String excelFile01 = '/Users/jack.c/git/Katalon_API_Testing/Data Files/STG_Login and FreeSpin.xlsx'
GlobalVariable.excel_path = excelFile01
...
WebUI.callTestCase(findTestCase('_STG/01_NuRGS/RGS History-Free Spin'), [:], FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('_STG/02_Back Office/PTH-Detail-Free Spin'), [:], FailureHandling.CONTINUE_ON_FAILURE)
