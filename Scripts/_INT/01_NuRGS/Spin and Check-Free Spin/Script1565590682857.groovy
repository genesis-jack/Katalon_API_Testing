...
String excelFile01 = '/Users/jack.c/git/Katalon_API_Testing/Data Files/INT_Login and FreeSpin.xlsx'
...
WebUI.callTestCase(findTestCase('_INT/01_NuRGS/RGS History-Free Spin'), [:], FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('_INT/02_Back Office/PTH-Detail-Free Spin'), [:], FailureHandling.CONTINUE_ON_FAILURE)
